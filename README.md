...
![Langraph](https://img.shields.io/badge/LangGraph-000000?style=flat&logo=langchain&logoColor=white)
...
>
> **Output includes:** Match Score (0–100), Strong Matches, Missing Skills, Resume Risks, Bullet Improvements, Tailored Summary, and Recommended Projects.
>
> `Python` `LangChain` `OpenAI` `ChromaDB` `spaCy` `Streamlit` `RAG`
...
>
> `Power BI` `Excel` `Data Analytics` `Data Visualization`
...
I'm always happy to connect — whether it's about a project idea, a job opportunity, or just a good tech conversation.
